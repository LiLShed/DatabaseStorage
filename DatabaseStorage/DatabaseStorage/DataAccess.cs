...
namespace DatabaseStorage
{
    ...
    {
        private static string connectionString = "Server=DESKTOP-H9SIIRN\\SQLEXPRESS;Database=Storage;TrustServerCertificate=True;Integrated Security=True;";
        ...
        public void UserDataRead()
        {
            ...
            {
                connection.Open();
                Console.WriteLine("Do you want to:\n1.Read All users;\n2.Read User by Username.");
                int chooseRead = int.Parse(Console.ReadLine());
                switch (chooseRead)
                {
                    case 1:
                        ReadAllUsers();
        ...
        public void UserDataDelete()
        {
            ...
            {
                connection.Open();
                Console.Write("\nEnter User, whose data u want to DELETE - ");
                string username = Console.ReadLine();
                ...
                connection.Close();
                Console.Write($"\nData about {username} is Deleted.\n");
            }
            Menu.UserMenu();
        }
        public void UserDataEdit()
        {
            ...
            {
                connection.Open();
                Console.Write("\nEnter User, whose data u want to Edit - ");
                string username = Console.ReadLine();
                ...
                string UPDATEhashedPassword = HashPassword(UPDATEpassword);//Hashing password
                Console.Write($"Enter user role of {username} (a-admin/u-user) - ");
                string UPDATEuserRole = Console.ReadLine();
                switch (UPDATEuserRole.ToLower())
                {
                    case "a":
                        UPDATEuserRole = "admin"; break;
                    case "u":
                        UPDATEuserRole = "user"; break;
                    case "admin":
                        UPDATEuserRole = "admin"; break;
                    case "user":
                        UPDATEuserRole = "user"; break;
                ...
                using (SqlCommand cmd = new SqlCommand(sql, connection))
                {
                    ...
                    cmd.Parameters.AddWithValue("@passwordHash", UPDATEhashedPassword);
                    cmd.Parameters.AddWithValue("@userRole", UPDATEuserRole);
                    cmd.ExecuteNonQuery();
                }
                connection.Close();
                Console.Write($"\nData about {username} is Edited.\n");
            }
        ...
        public void ProductDataDelete()
        {
            ...
            {
                connection.Open();
                Console.Write("\nEnter Product, which data u want to DELETE - ");
                string Productname = Console.ReadLine();
                ...
                connection.Close();
                Console.Write($"\nData about {Productname} is Deleted.\n");
            }
            Menu.UserMenu();
        }
        public void ProductDataEdit()
        {
            ...
            {
                connection.Open();
                Console.Write("\nEnter Product, which data u want to Edit - ");
                string productname = Console.ReadLine();
                Console.Write("Enter New ProductName  - ");
                string NEWproductname = Console.ReadLine();

                Console.WriteLine($"Enter CategoryId of  {NEWproductname}: ");
                Console.WriteLine("|                                          |\n" +
                                  "|1. __________Fruits and Vegetables_______;|\n" +
                                  "|2. _________________Tools________________;|\n" +
                                  "|3. _________________Goods________________;|\n" +
                ...
                Console.Write($"\nEnter quantity of  {NEWproductname} - ");
                int quantity = 0;
                try
                {
                    quantity = int.Parse(Console.ReadLine());
                ...
                Console.Write($"Enter Price of {NEWproductname} for 1 item - ");
                float price = 0.0f;
                try
                {
                    price = float.Parse(Console.ReadLine());
                ...
                string sql = "UPDATE Products SET ProductName = @newproductname, CategoryID = @categoryId, Quantity = @quantity, Price = @price WHERE ProductName = @productname";
                using (SqlCommand cmd = new SqlCommand(sql, connection))
                {
                ...
                connection.Close();
                Console.Write($"\nData about {productname} is Edited.\n");
            }
            Menu.UserMenu();
        }
        ...
        public void InventoryDataDelete()
        {
            ...
            {
                connection.Open();
                Console.Write("\nEnter Product, which data u want to DELETE from Inventory - ");
                string Productname = Console.ReadLine();
                ...
                connection.Close();
                Console.Write($"\nData about {Productname} is Deleted from Inventory.\n");
            }
            Menu.UserMenu();
        }
        public void InventoryDataEdit()
        {
            ...
            {
                connection.Open();
                Console.Write("\nEnter Product, whose data u want to Edit in Inventory - ");
                string productname = Console.ReadLine();
                ...
                Console.Write("Enter New ProductName  - ");
                string NEWproductname = Console.ReadLine();
                int nEWproductID = FindProductid(NEWproductname);
                Console.WriteLine(nEWproductID);
                Console.Write($"\nEnter quantityIN of {NEWproductname} in Inventory  - ");
                int quantityIN = 0;
                try
                {
                    quantityIN = int.Parse(Console.ReadLine());
                ...
                Console.Write($"\nEnter quantityOUT of {NEWproductname} from Inventory  - ");
                int quantityOUT = 0;
                try
                {
                    quantityOUT = int.Parse(Console.ReadLine());
                ...
                string sql = "UPDATE Inventory SET ProductId = @nEWproductID, QuantityIn = @quantityIN, QuantityOut = @quantityOUT, WHERE ProductID = @productID";
                using (SqlCommand cmd = new SqlCommand(sql, connection))
                {
        ...
        static int FindProductid(string productname)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
        ...
        static void ReadAllUsers()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(sql, connection))
                {
                    SqlDataReader reader = cmd.ExecuteReader();
                    // Call Read before accessing data.
                    Console.WriteLine("|UserID|Username______|PasswordHash|UserRole|CreatedAt__________|\n" +
                                      "|_______________________________________________________________|");
                    while (reader.Read())
                    {
                        int cell0 = reader.GetInt32(0);
                        string cell1 = reader.GetString(1);
                        string cell2 = reader.GetString(2);
                        string result = cell2.Substring(0, 5) + "...";
                        string cell3 = reader.GetString(3);
                        string cell4 = reader.GetDateTime(4).ToString();
                        Console.WriteLine($"|{cell0.ToString().PadRight(6, '_')}|{cell1.PadRight(14, '_')}|{result.ToString().PadRight(12, '_')}|" +
                                            $"{cell3.ToString().PadRight(8, '_')}|{cell4.PadRight(19, '_')}|");
                    }
                    reader.Close();
        ...
        static void ReadAllProducts()
        {
            ...
            {
                connection.Open();
                string sql = "Select ProductID, Products.ProductName, Categories.CategoryName, Products.CategoryID, Quantity, Price From Products\r\nJOIN Categories ON Products.CategoryID = Categories.CategoryID";

                using (SqlCommand cmd = new SqlCommand(sql, connection))
                {
                    SqlDataReader reader = cmd.ExecuteReader();
                    // Call Read before accessing data.
                    Console.WriteLine("|ProductID|ProductName___|CategoryName_________|CategoryID|Quantity|Price__|\n" +
                    ...
                    while (reader.Read())
                    {
                        ...
                        int cell3 = reader.GetInt32(3);
                        int cell4 = reader.GetInt32(4);
                        decimal cell5 = reader.GetDecimal(5);
                        Console.WriteLine($"|{cell0.ToString().PadRight(9, '_')}|{cell1.PadRight(14, '_')}|{cell2.PadRight(21, '_')}|" +
                                            $"{cell3.ToString().PadRight(10, '_')}|{cell4.ToString().PadRight(8, '_')}|{cell5.ToString().PadRight(7, '_')}|");
                    }
                    reader.Close();
